...
public class WearablSensorsDao {

    /** The Constant TAG. */
    private static final String TAG = "WearSensorDao";
     ...
     *            the context
     */
    public WearablSensorsDao(Context context) {
     ...
     *            the test mode
     */
    protected WearablSensorsDao(Context context, boolean testMode) {
        if (testMode) {
